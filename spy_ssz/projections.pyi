...
class BeaconBlockBodyElectra(Projection):
    ...
    @property
    def execution_payload(self) -> ExecutionPayloadElectra: ...
    @property
...
class BeaconBlockBodyFulu(Projection):
    ...
    def sync_aggregate(self) -> SyncAggregate: ...
    @property
    def execution_payload(self) -> ExecutionPayloadFulu: ...
    @property
    def bls_to_execution_changes(self) -> tuple[SignedBLSToExecutionChange, ...]: ...
    @property
    def blob_kzg_commitments(self) -> tuple[bytes, ...]: ...
...
class ExecutionPayloadEnvelope(Projection):
    ...
    @property
    def payload(self) -> ExecutionPayloadGloas: ...
    @property
    def execution_requests(self) -> ExecutionRequestsGloas: ...
    @property
    def builder_index(self) -> int: ...
    @property
    def beacon_block_root(self) -> bytes: ...
    @property
    def parent_beacon_block_root(self) -> bytes: ...
...
class ExecutionPayloadGloas(Projection):
    ...
    def excess_blob_gas(self) -> int: ...
    @property
    def block_access_list(self) -> bytes: ...
    @property
...
class SignedExecutionPayloadEnvelope(Projection):
    ...
    @property
    def message(self) -> ExecutionPayloadEnvelope: ...
    @property
    def signature(self) -> bytes: ...
